<aside class="row align-items-center header">
  ...
  <div class="col-6 header__infos d-flex align-items-center justify-content-end">
    ...
    <button type="button" class="btn btn--small btn--outline" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
    ...
    <div class="dropdown">
      <button class="btn btn--small btn--outline dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
        Matheus
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark">
        ...
        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Sair</a></li>
      </ul>
    </div>
  </div>
</aside>
